  ...
  return (
    <div className="dk-logo" aria-label="Digital Krantikari logo">
      <div className="dk-logo-mark">
        ...
        <span className="logo-cut logo-cut-alt" />
...
function App() {
  ...
  const primaryImageRoot = `${normalizedBasePath}image/Minimal`;
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => setShowWelcome(false), 2400);
  ...
  }, [featured.length, isAutoPlayPaused]);
      ...
      <header className="hero-shell">
        <div className="hero-frame">
          ...
          <div className="hero-copy hero-copy-centered">
            <p className="status-pill">Cinematic Brand Direction</p>
            <h1>
              Make Your Brand
              <br />
            ...
            <p>
              Luxury-grade identity design, campaign visuals, and conversion-focused web
              experiences crafted with cinematic detail and precision.
            </p>
          ...
          <div className="trust-row">
            <span>Identity Films</span>
            <span>Luxury Print</span>
